...
const updateAnimal = (arr, callback) => {
  // Solution code here...
  // the .forEach will allow us to push each animal to an array after passing it through the callback function
  let localArray = [];
  arr.forEach(animal => {
    localArray.push(callback(animal));
  });
  return localArray;
};
...
const sortNames = (arr) => {
  // Solution code here...
  //I believe sorting the names by utf value should work here
  return arr.sort();
};
...
const sortNumbers = (arr) => {
  // Solution code here...
  //we'll need to write our own comparison function here, the function should return -1 if a < b, 0 if a==b, and 1 if a>b
  return arr.sort((a,b) => {
    if (a < b) {
      return -1;
    } else if(a > b) {
...
const sortBackwards = (arr) => {
  // Solution code here...
  // we just need to reverse the logic for the previous function here, so a > b returns -1, a < b: 1, and so on
  return arr.sort((a,b) => {
    if (a < b) {
      return 1;
    } else if (a > b) {
...
const alphabetize = (arr) => {
  // Solution code here...
  //the default behavior for the sort method should work here
  return arr.sort();
};
...
const sortByPrice = (arr) => {
  // Solution code here...
  // our .sort callback is looking at item.price here. if item1.price < item2.price return -1, if item1.price > item2.price return 1...
