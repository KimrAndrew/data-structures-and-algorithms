...
const addTwo = (arr) => {
  // Solution code here...
  //we need to iterate over an array using a for loop, for each element in the array, we should add two to the number held at that index and push it to a new array
  let localArray = [];
...
const typeNum = (arr) => {
  // Solution code here...
  // we need to use the .filter method to filter out the elements that aren't typeof number
...
const containsAnd = (arr) => {
  // Solution code here...
  // the string.includes() method should work handily here
...
const oddValues = (arr) => {
  // Solution code here...
  // the callback for the .filter method should return true for values such that num % 2 != 0
