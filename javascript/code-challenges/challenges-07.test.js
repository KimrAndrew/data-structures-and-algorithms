...
------------------------------------------------------------------------------------------------ */
//compare function should compare each object.height
let starWarsPeople = [
  {
    "name": "C-3PO",
    "height": "167",
...
const sortStarWarsCharacters = (starWarsArr) => {
  let returnArr = starWarsArr.sort((a,b) => {
...
const listFoods = (recipe) => {
  ...
  recipe.ingredients.forEach(ingredient => {
    for(let i = 0; i < 2; i++) {
      let space = ingredient.indexOf(' ') + 1;
      ingredient = ingredient.slice(space);
    }
