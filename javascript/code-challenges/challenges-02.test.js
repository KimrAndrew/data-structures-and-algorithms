...
const addQuestion = (arr) => {
  // Solution code here...
  //we want to use .map to append "?" to the end of each string in given array
...
const forLoopTwoToThe = (arr) => {
  // Solution code here...
  // we need to iterate over the array using a for loop, push the new value to a temporary array, then return the temp array after the for loop is done
  let localArray = [];
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  // we need to use the forEach method to take each num, raise two to the power of num, then push that result to a new array
  let localArray = [];
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  // we need to return the output of running the map function with a callback function that returns the value of 2 to the power of num
...
const charCode = (arr) => {
  // Solution code here...
  // we need to return the output of mapping the charCodteAt method to each item in the given array
...
const evenOdd = (arr) => {
  // Solution code here...
  // so we're checking whether each item in the array is 1. a number, and 2. divisible by 2
  // if num % 2 === 0, that element should be mapped as "even" or be mapped "odd" otherwise
  return arr.map(el => {
    if(typeof el !== "number") {
      return "N/A";
    }
...
const extractAbilities = (arr) => {
  // Solution code here...
  // we're using map to extract all the ability names
  // the name property is a property of an object nested in another object, we can use the dot operator to access abilityData.ability.name
  return arr.map(abilityData => abilityData.ability.name);
};
...
const extractStats = (arr) => {
  // Solution code here...
  // we'll be creating an array of object literals using the map method
  // we can get the stat name at snorlaxStats.stats.stat.name and the total from ...stats.effort + ...stats.baseStat
  // the function is being given the array held in the stats property
  return arr.map(statObj => {
    return {'name': statObj.stat.name, 'total': statObj.effort + statObj.baseStat};
  });
};
