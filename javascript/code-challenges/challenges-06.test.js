...
const getNames = (arr) => {
  ...
  return arr.map(person => {
    //split string into char array so it can be reversed
...
const appendFirstToLast = (arr) => {
  // Solution code here...
  // since arrays are passed by reference, arr is the same array that was
  // passed as a param. Any changes made to arr will be reflected outside
  // the function
  arr.push(arr[0]);
};
...
const addBirthYearProperty = (obj, year) => {
  // Solution code here...
  // just like arrays, objects are passed by reference. Any changes made
  // in the function will be reflected outside of it
  obj['yearBorn'] = year;
};
